...
class App_prediction_from_id:
    ...
    def app():
        ...
        if predict_btn:
            ...
            my_placeholder1.metric("Not solvable", "{} %".format(round(pred["proba_0"],3)))
            my_placeholder2.metric("Solvable", "{} %".format(round(pred["proba_1"],3)))

            fig, ax = plt.subplots(1,1, figsize = (4,4))
            fig.suptitle("Customer {}".format(client_ID))
            ax.set_title("The probability of solvability is {} %".format(round(pred["proba_1"],3)))
